...
/* ---------- Homepage FAQs ---------- */
const homeFaqs = [
  { question: "Who is the best plastic surgeon in Haldwani?", answer: "Dr. Sarika Gangwar is widely regarded as the best plastic and cosmetic surgeon in Haldwani, Uttarakhand with over 12 years of experience and 3,500+ successful procedures." },
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-4 rounded-2xl bg-white p-8 shadow-2xl md:grid-cols-4 md:gap-8">
            {[
              ...
              { number: "MCh", label: "Plastic Surgery" },
