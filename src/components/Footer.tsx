          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-colors hover:bg-[#E1306C] hover:text-white"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-colors hover:bg-[#1877F2] hover:text-white"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {CLINIC_LOCATIONS.map((loc) => (
                <li key={loc.name} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/50">{loc.role}</p>
                    <p className="mt-0.5 text-xs">{loc.days}: {loc.hours}</p>
                  </div>
                </li>
              ))}
