...
export const services: Service[] = [
  /* ==================== FACE (7 SERVICES) ==================== */
  {
    ...
    slug: "face-lift",
    category: "Face",
    shortDescription: "Turn back the clock with a natural-looking face lift that restores youthful contours and tightens sagging skin.",
    overview: "A face lift (rhytidectomy) is a surgical procedure that reduces visible signs of aging in the face and neck. Dr. Sarika Gangwar uses advanced techniques to reposition deep facial tissues, remove excess skin, and smooth wrinkles — delivering results that look refreshed, never pulled. This procedure is ideal for patients experiencing jowling, deep creases, and loss of facial definition. With over 8 years of specialized experience in facial rejuvenation, Dr. Gangwar has perfected techniques that deliver natural, transformative results for patients across North India.",
    whyNeeded: "As we age, the face loses fat and elasticity, leading to sagging skin, deep folds, and jowls. Environmental factors, genetics, and gravity accelerate these changes. A face lift addresses these concerns at the structural level, restoring a naturally youthful facial profile that creams and non-surgical treatments cannot achieve. The procedure is not just cosmetic — it restores confidence and improves quality of life for thousands of patients.",
    eligibility: ["Adults aged 40–70 with visible facial sagging", "Non-smokers or willing to quit 4 weeks before surgery", "Good overall health without uncontrolled medical conditions", "Realistic expectations about outcomes", "Skin with some elasticity remaining"],
    procedureSteps: [
      { step: 1, title: "Consultation & Planning", description: "Detailed facial analysis, 3D imaging, discussion of goals, and customized surgical plan created specifically for your anatomy." },
      { step: 2, title: "Anesthesia", description: "General anesthesia or IV sedation administered for your complete comfort and safety throughout the procedure." },
      { step: 3, title: "Incisions", description: "Discreet incisions along the hairline and around the ears, hidden in natural creases where they fade into the hairline and ear contours." },
      { step: 4, title: "Tissue Repositioning", description: "Deep facial tissues (SMAS layer) are carefully lifted and repositioned for long-lasting results that address the structural causes of aging." },
      { step: 5, title: "Closure & Recovery", description: "Excess skin is removed, incisions are closed with fine sutures using precision techniques, and a compression bandage is applied for optimal healing." },
    ],
    recoveryTimeline: [
      { period: "Day 1–3", description: "Rest at home in a reclined position. Mild swelling and bruising are normal. Pain managed with prescribed medication. Sleep elevation is essential." },
      { period: "Week 1", description: "Sutures removed by Dr. Gangwar. Swelling begins to subside noticeably. Bruising fades with makeup coverage. Light walking encouraged; strenuous activity avoided." },
      { period: "Week 2–4", description: "Most bruising resolves completely. Return to normal daily activities. Light exercise may resume. Final results beginning to emerge." },
      { period: "Month 2–3", description: "Complete swelling resolution. Final results fully visible. Scars continue to fade and become virtually invisible over the following months." },
    ],
    results: "Patients typically look 8–12 years younger with natural, refreshed facial contours. Results last 7–10 years. Many patients report a significant boost in confidence, improved social interactions, and dramatically improved quality of life. The transformation is noticeable but never 'overdone' — you'll still look like yourself, just refreshed.",
    safetyNotes: "Face lift surgery is performed in a fully equipped, accredited operating theater with board-certified anesthesiologists. Dr. Gangwar follows strict international safety protocols, and all procedures include comprehensive pre-operative health screening and post-operative monitoring to ensure optimal outcomes. Complication rates are minimized through meticulous surgical technique and careful patient selection.",
    faqs: [
      { question: "How long does a face lift last?", answer: "Results typically last 7–10 years, with most patients seeing significant benefits for 8+ years. While aging continues naturally, you will always look younger than if you hadn't had the procedure. Many patients opt for minor touch-ups after 10 years." },
  ...
  },
  {
    ...
    procedureSteps: [
      { step: 1, title: "Consultation & Assessment", description: "Detailed assessment of brow position, forehead lines, eyebrow shape, and overall facial harmony to create a personalized surgical plan." },
      { step: 2, title: "Anesthesia", description: "General anesthesia or conscious sedation administered for patient comfort and safety." },
      { step: 3, title: "Endoscopic Technique", description: "Small incisions (3–5mm each) are made behind the hairline where they are completely hidden. An endoscope guides the surgeon to precisely reposition tissues." },
      { step: 4, title: "Brow Elevation", description: "Underlying tissues and muscles are carefully adjusted and secured at a higher, more youthful position. Forehead lines are smoothed in the process." },
      { step: 5, title: "Recovery & Closure", description: "Minimal sutures close the tiny incisions, which are hidden by hair. Recovery begins immediately with rapid healing." },
    ],
    recoveryTimeline: [
      { period: "Day 1–3", description: "Mild swelling around forehead and eyes. Rest recommended. Bruising is typically minimal with the endoscopic technique." },
      { period: "Week 1", description: "Most swelling resolves noticeably. Resume light activities like walking and office work. Avoid heavy lifting." },
      { period: "Week 2–3", description: "Resume normal activities. Return to exercise. Final results beginning to show." },
      { period: "Month 1–2", description: "Swelling completely resolved. Final results settle perfectly. Scars fade and become completely invisible." },
    ],
  ...
  },
  {
    ...
    slug: "blepharoplasty",
    category: "Face",
    shortDescription: "Remove puffy bags, excess skin, and drooping eyelids to reveal brighter, more youthful eyes.",
    overview: "Blepharoplasty is a precise surgical procedure that corrects droopy eyelids, under-eye bags, and puffiness by removing or repositioning excess fat and skin around the eyes. Dr. Sarika Gangwar customizes upper and lower blepharoplasty to each patient's unique anatomy for results that look natural and refreshed. This is one of the most popular facial procedures because it has an immediate, dramatic impact on appearance.",
    whyNeeded: "Aging, genetics, and sun exposure cause the delicate skin around the eyes to stretch and sag. This creates a tired, aged appearance and can even impair peripheral vision in severe cases. Blepharoplasty restores a youthful, alert look to the eye area — often causing patients to be told they 'look so well-rested' after the procedure.",
    eligibility: ["Adults with drooping upper eyelids or under-eye bags", "Good overall eye health (no glaucoma or dry eye issues)", "Non-smokers for optimal healing", "Realistic expectations about outcomes", "Consultation to discuss individual anatomy"],
    procedureSteps: [
      { step: 1, title: "Comprehensive Eye Evaluation", description: "Detailed eye examination, vision assessment, and facial analysis to plan customized treatment." },
      { step: 2, title: "Anesthesia", description: "Local anesthesia with sedation to ensure complete comfort while maintaining your natural appearance." },
      { step: 3, title: "Upper Lid Correction", description: "Precise incision in the natural crease of the eyelid; excess skin and fat are carefully removed." },
      { step: 4, title: "Lower Lid Correction", description: "Incision just below the lashes or inside the lid (transconjunctival); fat is repositioned to create smooth contour." },
      { step: 5, title: "Precise Closure", description: "Fine sutures close incisions along natural lines for minimal visible scarring." },
    ],
    recoveryTimeline: [
      { period: "Day 1–3", description: "Cold compresses applied regularly. Head elevation maintained. Mild bruising and swelling expected. Pain is minimal." },
      { period: "Week 1", description: "Sutures removed by Dr. Gangwar. Bruising fades significantly. Swelling begins to subside. Return to office work." },
      { period: "Week 2", description: "Resume normal activities. Makeup can conceal residual marks. Exercise may resume cautiously." },
      { period: "Month 1", description: "Final results fully visible. Scars hidden in natural creases become virtually invisible." },
    ],
    results: "Brighter, more open eyes with a refreshed, alert appearance. Patients report others saying they 'look so well-rested.' Results are long-lasting, typically 10+ years. Significant improvement in confidence and quality of life.",
    safetyNotes: "Performed with meticulous precision to protect delicate eye structures. Pre-operative eye health screening is mandatory. Ophthalmology consultation recommended for patients with dry eye or other eye conditions.",
    faqs: [
